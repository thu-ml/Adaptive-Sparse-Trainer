...
class DynamicStreamingDataset(StreamingDataset):
    ...
    def __iter__(self) -> Iterator[Dict[str, Any]]:
        ...
        while True:
            ...
            # len(domain_sample_id) is the number of samples in the domain, using self.samples_per_stream[stream_id] will lead to out of sample
            domain_sample_id = domain_sample_id[self.used_num_samples_per_stream[stream_id] % len(domain_sample_id)]
